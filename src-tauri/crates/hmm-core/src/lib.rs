...
pub use external_import::{
    ...
    ExternalImportItemResult, ExternalImportItemStatus, ExternalImportItemStatusCounts,
    ExternalImportMaterializationBudget, ExternalImportMetadataHint, ExternalImportProvenance,
    ExternalImportProvenanceError, ExternalImportReasonCode, ExternalImportResourceBudget,
    ExternalImportResourceUsage, ExternalImportScanStatus, ExternalImportSelection,
    ExternalImportSelectionDecision, ExternalImportSelectionEntry, ExternalImportSelectionError,
    ...
    ExternalImportSourceId, DEFAULT_EXTERNAL_IMPORT_BATCH_MAX_FILES,
    ...
    EXTERNAL_IMPORT_HISTORY_SCAN_ONLY_TTL_MILLIS, EXTERNAL_IMPORT_SELECTION_MAX_ITEMS,
