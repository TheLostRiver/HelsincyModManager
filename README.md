...
首次设置、每天/每周计划、首次启用补做、关机后补备份、时区、保留策略和安全恢复的详细通俗说明，见
[存档备份与恢复使用指南](docs/SAVE_BACKUP_USER_GUIDE.md)。其他功能说明见 [项目功能介绍](docs/PROJECT_FEATURES.md)。
...
- [存档备份与恢复使用指南](docs/SAVE_BACKUP_USER_GUIDE.md)：从首次备份到退出后保护，讲清触发时机、关机补做、时区、整理与恢复。
