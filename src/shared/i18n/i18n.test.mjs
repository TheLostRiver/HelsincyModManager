...
test("copy 字典三语齐全并由 satisfies 锁定", () => {
  for (const relativePath of [
    ...
    "src/features/settings/modStorageCopy.ts",
    "src/features/settings/modImportSettingsCopy.ts",
    ...
    "src/features/replacements/retargetDialogCopy.ts",
...
test("试点页与设置页内嵌面板去注释后不再包含硬编码中文文案", () => {
  for (const relativePath of [
    ...
    "src/features/settings/ModStorageSettingsPanel.tsx",
    "src/features/settings/ModImportSettingsPanel.tsx",
    "src/features/settings/modImportSettingsTypes.ts",
    "src/features/settings/ModStorageSettingsProvider.tsx",
    "src/features/settings/modStorageTypes.ts",
    "src/features/settings/modStorageMigrationTaskState.ts",
    "src/features/settings/useModStorageSettings.ts",
    ...
    "src/features/mods/ExternalStateSessionProvider.tsx",
    "src/features/mods/externalStateSession.ts",
    ...
    "src/features/replacements/EquipmentRetargetDialog.tsx",
    "src/features/replacements/RetargetWorkspace.tsx",
