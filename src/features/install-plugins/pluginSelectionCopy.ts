...
export const pluginSelectionCopy = {
  zh_cn: {
    title: "插件与随包附件", hint: "选择会保存到当前游戏安装；确认安装或重新应用后才修改游戏文件。",
    draftHint: "选择仅作用于当前游戏安装，保存后生效。", dependency: "未声明具体功能依赖；跳过插件可能影响 Mod 的部分功能。",
    loading: "正在检查插件…", saving: "正在保存选择…", managed: "已管理", retained: "仅保留已安装文件",
    packageExcluded: "已在包文件设置中排除", retry: "重新检查", failed: "暂时无法读取插件选择，请重新检查。", noProfile: "游戏安装信息就绪后可管理插件。",
    confirm: "确认并安装", cancel: "取消", preview: "预览安装变更", apply: "确认应用到游戏", noChanges: "当前文件无需更新。",
  ...
  en: {
    title: "Plugins and bundled files", hint: "Choices are saved for this game installation. Game files change only after you confirm installation or reapply.",
    draftHint: "Choices apply to this game installation after saving.", dependency: "Specific dependencies are not declared; skipping plugins may affect some Mod features.",
    loading: "Checking plugins…", saving: "Saving choices…", managed: "Managed", retained: "Keep installed file only",
    packageExcluded: "Excluded in package file settings", retry: "Check again", failed: "Plugin choices are unavailable. Please check again.", noProfile: "Wait until the game installation is ready to manage plugins.",
    confirm: "Confirm and install", cancel: "Cancel", preview: "Preview installation changes", apply: "Confirm and apply to game", noChanges: "No file updates are needed.",
  ...
  ja: {
    title: "プラグインと付属ファイル", hint: "選択は現在のゲームインストールに保存されます。インストールまたは再適用を確定するまでゲームファイルは変更されません。",
    draftHint: "保存後、現在のゲームインストールに選択が適用されます。", dependency: "具体的な依存関係は宣言されていません。除外すると Mod の一部機能に影響する場合があります。",
    loading: "プラグインを確認中…", saving: "選択を保存中…", managed: "管理済み", retained: "インストール済みファイルのみ保持",
    packageExcluded: "パッケージのファイル設定で除外済み", retry: "再確認", failed: "選択を読み取れません。再確認してください。", noProfile: "ゲームのインストール情報を読み込むとプラグインを管理できます。",
    confirm: "確定してインストール", cancel: "キャンセル", preview: "インストール変更を確認", apply: "確認してゲームに適用", noChanges: "ファイルの更新は不要です。",
