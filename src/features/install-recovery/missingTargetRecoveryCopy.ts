...
export const missingTargetRecoveryCopy = {
  zh_cn: {
    ...
    panel: { statusAria: "缺失文件恢复状态", progressAria: "卸载清理进度", previewingTitle: "正在检查卸载清理条件", startingTitle: "正在启动卸载清理",
      ...
      completedTitle: "卸载清理完成", completedBody: (name: string) => `${name} 的安装记录已清理，已重新扫描当前游戏。`, failedTitle: "卸载清理未完成" },
    ...
    blockReasons: { install_state_unavailable: "安装记录无法验证", target_state_unavailable: "文件已变化或无法验证，请重新扫描", backup_unavailable: "所需备份缺失或无法读取", recovery_pending: "游戏安装记录中还有未完成的恢复事务，请先处理", preview_required: "请先重新预览卸载清理方案", game_running: "请先关闭游戏", game_running_unknown: "无法确认游戏是否运行，请稍后重试" },
    taskErrors: {
  ...
  en: {
    ...
    panel: { statusAria: "Missing file recovery status", progressAria: "Uninstall progress", previewingTitle: "Checking uninstall conditions", startingTitle: "Starting uninstall",
      ...
      completedTitle: "Uninstall completed", completedBody: (name: string) => `Installation records for ${name} were cleared. The current game was scanned again.`, failedTitle: "Uninstall did not complete" },
    ...
    blockReasons: { install_state_unavailable: "Installation records cannot be verified", target_state_unavailable: "Files changed or cannot be verified; scan again", backup_unavailable: "A required backup is missing or unreadable", recovery_pending: "Resolve the game's pending recovery transactions first", preview_required: "Review a new uninstall plan first", game_running: "Close the game first", game_running_unknown: "Game running state is unknown; retry later" },
    taskErrors: {
  ...
  ja: {
    ...
    panel: { statusAria: "欠落ファイルの復旧状態", progressAria: "アンインストールの進捗", previewingTitle: "アンインストール条件を確認中", startingTitle: "アンインストールを開始中",
      ...
      completedTitle: "アンインストール完了", completedBody: (name: string) => `${name} のインストール記録を整理し、現在のゲームを再スキャンしました。`, failedTitle: "アンインストール未完了" },
    ...
    blockReasons: { install_state_unavailable: "インストール記録を検証できません", target_state_unavailable: "ファイルが変更されたか検証できません。再スキャンしてください", backup_unavailable: "必要なバックアップが欠落しているか読み取れません", recovery_pending: "先にゲームの未完了の復旧処理を解決してください", preview_required: "先にアンインストール内容を再確認してください", game_running: "先にゲームを終了してください", game_running_unknown: "ゲームの起動状態を確認できません。後ほどお試しください" },
    taskErrors: {
