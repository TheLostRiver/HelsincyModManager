...
export const modDeleteCopy = {
  zh_cn: {
    dialog: {
      ...
      affectedProfiles: "有记录的游戏安装",
      affectedProfilesEmpty: "无安装记录",
  ...
  en: {
    dialog: {
      ...
      affectedProfiles: "Game installations with records",
      affectedProfilesEmpty: "No installation records",
  ...
  ja: {
    dialog: {
      ...
      affectedProfiles: "記録のあるゲームインストール",
      affectedProfilesEmpty: "インストール記録なし",
