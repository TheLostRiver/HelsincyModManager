  ...
  zh_cn: {
    ...
    result: {
      ...
      errors: {
        ...
        mod_storage_migration_in_progress: "存储目录正在迁移，完成后再重试",
    ...
    selection: {
      errors: {
        ...
        mod_storage_migration_in_progress: "存储目录正在迁移，完成后再开始导入",
        mod_storage_restart_required: "存储目录已更改，请先重启 HMM",
  ...
  en: {
    ...
    result: {
      ...
      errors: {
        ...
        mod_storage_migration_in_progress: "The storage directory is being migrated; retry after it finishes",
    ...
    selection: {
      errors: {
        ...
        mod_storage_migration_in_progress: "The storage directory is being migrated; start the import after it finishes",
        mod_storage_restart_required: "The storage directory changed; restart HMM first",
  ...
  ja: {
    ...
    result: {
      ...
      errors: {
        ...
        mod_storage_migration_in_progress: "保存フォルダーの移行中です。完了後に再試行してください",
    ...
    selection: {
      errors: {
        ...
        mod_storage_migration_in_progress: "保存フォルダーの移行中です。完了後にインポートを開始してください",
        mod_storage_restart_required: "保存フォルダーが変更されました。先に HMM を再起動してください",
