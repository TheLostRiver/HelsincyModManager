  ...
  zh_cn: {
    page: {
      ...
      queryErrors: {
        ...
        mod_library_profile_context_required: "请先配置游戏目录",
      ...
      statusFilter: {
        needProfile: "游戏安装信息就绪后，即可按安装状态筛选。",
        unsupported: "当前安装状态筛选不受支持，请选择其他筛选条件。",
        profileLoading: "游戏安装信息加载中",
        selectProfile: "游戏安装信息就绪后可用",
      },
      uninstallBlocked: {
        profileChanged: "游戏安装信息已变化，请重新确认后卸载。",
      ...
      cardAction: {
        ...
        selectProfileFirst: "游戏安装信息就绪后可执行此操作",
    ...
    compact: {
      ...
      waitInstallTask: "请等待当前安装任务完成",
      selectProfileFor: (actionLabel) => `游戏安装信息就绪后可${actionLabel}`,
      actionLabels: {
        previewPlan: "预览安装计划",
        install: "安装",
        reinstall: "重装",
  ...
  en: {
    page: {
      ...
      queryErrors: {
        ...
        profile_id_empty: "Invalid game installation context",
        ...
        mod_library_profile_context_required: "Configure the game directory first",
      ...
      statusFilter: {
        needProfile: "Install-status filters are available once the game installation is ready.",
        unsupported: "This install-status filter is not supported. Choose another filter.",
        profileLoading: "Loading game installation",
        selectProfile: "Available once the game installation is ready",
      },
      uninstallBlocked: {
        profileChanged: "The game installation changed. Review it again before uninstalling.",
      ...
      cardAction: {
        ...
        selectProfileFirst: "Wait until the game installation is ready",
    ...
    selection: {
      ...
      resetReasons: {
        ...
        "profile-changed": "The game installation directory changed",
    ...
    contextMenu: {
      ...
      fileModify: "Mod file retargeting",
    ...
    compact: {
      ...
      waitInstallTask: "Wait for the current install task to finish",
      selectProfileFor: (actionLabel) => `Wait for the game installation to ${actionLabel}`,
      actionLabels: {
  ...
  ja: {
    page: {
      ...
      queryErrors: {
        ...
        profile_id_empty: "現在のゲームのインストール情報が無効です",
        ...
        mod_library_profile_context_required: "先にゲームフォルダーを設定してください",
      ...
      statusFilter: {
        needProfile: "ゲームのインストール情報を読み込むと、状態で絞り込めます。",
        unsupported: "このインストール状態フィルターは未対応です。別のフィルターを選択してください。",
        profileLoading: "ゲームのインストール情報を読み込み中",
        selectProfile: "ゲームのインストール情報の取得後に利用可能",
      },
      uninstallBlocked: {
        profileChanged: "ゲームのインストール情報が変わりました。再確認してからアンインストールしてください。",
      ...
      cardAction: {
        ...
        selectProfileFirst: "ゲームのインストール情報の取得後に実行できます",
    ...
    selection: {
      ...
      resetReasons: {
        ...
        "profile-changed": "ゲームのインストール先が変わりました",
    ...
    compact: {
      ...
      waitInstallTask: "現在のインストールタスクの完了をお待ちください",
      selectProfileFor: (actionLabel) => `ゲームのインストール情報の取得後に${actionLabel}できます`,
      actionLabels: {
