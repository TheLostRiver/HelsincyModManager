...
export const batchModLifecycleCopy = {
  zh_cn: {
    ...
    reasonCodes: {
      ...
      reinstall_original_install_unverified: "旧安装与原包无法核实一致，请先卸载后从替换目标页安装",
      reinstall_installed_attachment_unverified: "已安装附件无法核实，请先检查或恢复文件",
  ...
  en: {
    ...
    reasonCodes: {
      ...
      reinstall_original_install_unverified: "The old installation cannot be verified against its package. Uninstall it and install from replacement targets.",
      reinstall_installed_attachment_unverified: "Installed companion files could not be verified. Check or recover them first.",
  ...
  ja: {
    ...
    reasonCodes: {
      ...
      reinstall_original_install_unverified: "以前のインストールを元パッケージと照合できません。アンインストール後に置換先ページからインストールしてください。",
      reinstall_installed_attachment_unverified: "インストール済み付属ファイルを確認できません。先にファイルを確認または復元してください。",
