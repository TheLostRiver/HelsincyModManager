  ...
  zh_cn: {
    task: {
      ...
      blockingReasons: {
        ...
        original_install_unverified: "无法证明旧安装与原包一致，不能安全恢复装备来源。请先卸载，再从替换目标页安装。",
        installed_attachment_unverified: "无法核实已安装附件的来源或内容。请先检查或恢复文件，再切换目标。",
  ...
  en: {
    task: {
      ...
      blockingReasons: {
        ...
        original_install_unverified: "The old installation cannot be verified against the original package. Uninstall it, then install from the replacement targets page.",
        installed_attachment_unverified: "The installed companion files could not be verified. Check or recover them before switching targets.",
  ...
  ja: {
    task: {
      ...
      blockingReasons: {
        ...
        original_install_unverified: "以前のインストールが元のパッケージと一致することを確認できません。アンインストール後、置換先ページから再インストールしてください。",
        installed_attachment_unverified: "インストール済み付属ファイルを確認できません。ファイルを確認または復元してから置換先を変更してください。",
