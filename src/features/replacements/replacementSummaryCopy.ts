...
export const replacementSummaryCopy = {
  zh_cn: {
    ...
    profileRequired: "未选择配置档", kinds: { armor: "防具", weapon: "武器", kinsect: "猎虫" },
  },
  en: {
    ...
    profileRequired: "No profile selected", kinds: { armor: "Armor", weapon: "Weapon", kinsect: "Kinsect" },
  },
  ja: {
    ...
    profileRequired: "プロファイル未選択", kinds: { armor: "防具", weapon: "武器", kinsect: "猟虫" },
  },
