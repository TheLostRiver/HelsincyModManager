...
export const replacementSummaryCopy = {
  zh_cn: {
    ...
    profileRequired: "游戏安装信息未就绪", kinds: { armor: "防具", weapon: "武器", kinsect: "猎虫" },
  },
  en: {
    ...
    profileRequired: "Game installation unavailable", kinds: { armor: "Armor", weapon: "Weapon", kinsect: "Kinsect" },
  },
  ja: {
    ...
    profileRequired: "ゲームのインストール情報未取得", kinds: { armor: "防具", weapon: "武器", kinsect: "猟虫" },
  },
