...
export const retargetFileCopy = {
  zh_cn: {
    ...
    reasons: {
      ...
      plugin_selected: "按当前游戏安装的选择包含插件，保留插件原始位置。",
  ...
  en: {
    ...
    reasons: {
      ...
      plugin_selected: "Include the plugin selected for this game installation at its original location.",
  ...
  ja: {
    ...
    reasons: {
      ...
      plugin_selected: "このゲームインストールで選択したプラグインを元の位置に配置します。",
