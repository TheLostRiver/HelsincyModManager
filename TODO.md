...
**前置**: 无
**状态**: **A / B 已合并**（2026-09-07 立项，2026-09-08 拍板接入方式与顺序）；C（rar）待开工
...
|------|------|------|-----------|
| 可导入 | 正常 Mod 包 | ✅ 勾选 | — |
| 格式不支持 | `.rar`（T21-C 落地前） | ❌ 不勾选 | **否**——链路根本读不了 |
...
| T21 压缩包格式扩展 | P2（T21-A 为 P1） | **A / B 已合并**（#370 档位与失败原因通道、#371 安全外壳与格式解耦）；下一步 **C rar（自 vendor UnRAR 7.23 ＋ FFI）**，再 D 7z；**E tar 家族已延后** | 缺陷面见 #348（**C/D 落地前不关闭**）；上限口径疑点已实测证实并由 #367 单独修复 |
