...
**前置**: T2
**状态**: 进行中（P7.2a Windows Scheduled Task 平台注册、健康核心和 sidecar 基础已落地；安装态 runtime smoke、P7.2b 用户启用/退出体验和完整备份中心仍待后续切片）
**预估**: 大
...
| T7 一键启动 | P1 | 已完成 | #125 |
| T8 存档备份 | P2 | 进行中（P7.2a Windows 平台核心与 sidecar 已落地；安装态 runtime smoke、P7.2b 用户启用/退出体验和备份中心待后续切片） | |
