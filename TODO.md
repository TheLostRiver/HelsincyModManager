...
| I18N-06 shell + categories + diagnostics + 备份中心三语（并入 I18N-07 firstRunTour） | P2 | in-progress | categories/diagnostics/备份中心（盘点补入，原切片计划遗漏）/shell/frame/window-lifecycle/feedback 基元/onboarding 全域三语；settings 余量盘点为零；firstRunTour 长文案（原 I18N-07）随本切片一并交付，交付后前端文案线闭合，仅剩 I18N-08 catalog 契约 |
